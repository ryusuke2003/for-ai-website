...
export function TimerSettings() {
  ...
  return (
    <>
      <div className="presets mt-[18px] flex flex-col items-center gap-2.5" aria-label="タイマー時間と完了通知">
        <div className="flex flex-wrap justify-center gap-2.5" aria-label="タイマー時間">
        ...
        <div className="flex flex-wrap justify-center gap-2.5" aria-label="完了時の設定">

...
def main():
    ...
    require('aria-valuetext={dailyGoal.progressAriaValueText || undefined}' in progress_markup,
            "進捗の読み上げ文をReact hookから設定してください")
    ...
    require("buildDailyGoalProgressSnapshot" not in INTEROP_SOURCE,
            "日次目標進捗をlegacy interopへ戻さないでください")
    require("goalProgress" not in INTEROP_SOURCE,
            "ProgressDetails snapshotに日次目標進捗を含めないでください")

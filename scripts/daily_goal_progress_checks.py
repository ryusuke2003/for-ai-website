...
def main():
    ...
    require(not (ROOT / "timer-progress.css").exists(), "旧timer-progress.cssを復活させないでください")

    print("Daily goal progress is React-owned and its shared CSS lives in src/tailwind.css.")

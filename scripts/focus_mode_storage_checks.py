...
def main():
    ...
    require(not (ROOT / "app.js").exists(),
            "削除済みclassic app.jsへ集中表示runtimeを戻さないでください")
    ...
    print("Focus mode is React-owned; classic runtime, timer interop, and hidden scaffold stay removed.")
